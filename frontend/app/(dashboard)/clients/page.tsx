                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <div className="relative inline-block">
                                                <button
                                                    ...
                                                    className="p-2 rounded-md hover:bg-[var(--surface-dim)] transition-colors"
                                                    title="Actions"
                                                >
                                                ...
                                                {openMenuId === client.id && (
                                                    <div className="absolute right-0 mt-2 w-40 bg-white dark:bg-[var(--surface)] border border-[var(--border-subtle)] rounded-md shadow-md z-10">
                                                        <Link
                                                            ...
                                                            className="flex items-center w-full text-left px-3 py-2 text-sm text-[var(--foreground)] hover:bg-[var(--surface-dim)] transition-colors"
                                                        >
                                                        ...
                                                        <button
                                                            ...
                                                            className="flex items-center w-full text-left px-3 py-2 text-sm text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors"
                                                        >
